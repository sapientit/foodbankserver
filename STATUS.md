...
| **7 — pick lists**             | `pick_lists`, `parcels`, `parcel_lines`. Generated on first view in five reads and one native D1 batch whatever the referral count; editable while draft _and_ after printing; locked on confirm. Neither print route serves a list with an unreviewed parcel on it. Print payload ordered by shelf.                                                                                                                                                                                                                                                                                                                                                       |
